...
# Step 1: Login to DockerHub (optional, if you're already logged in, you can skip this)
echo "Logging in to DockerHub..."
docker login -u "$DOCKER_USERNAME"

# Step 2: Tag the image with multiple tags and push each tag
...
# Step 3: Confirm the image was pushed successfully with all tags
